...
export function SubjectFeed({ subjectId, notes }: SubjectFeedProps) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="icon" className="h-9 w-9 border-neutral-200 dark:border-neutral-800">
      ...
      {filteredNotes.length > 0 ? (
        ...
        <div className="py-20 text-center flex flex-col items-center justify-center">
          ...
          <p className="text-neutral-500 max-w-xs mx-auto">
            {search ? `No results for "${search}" in this category.` : "There are no notes uploaded for this subject yet."}
          </p>
          {!search && (
            <Button className="mt-6 bg-indigo-600">Be the first to upload</Button>
          )}
        </div>
      )}
    </div>
